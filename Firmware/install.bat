...
set SetupArgs=--before default_reset --after hard_reset write_flash -z --flash_mode dout --flash_freq 40m --flash_size keep
...
%EsptoolPath% %BaseArgs% %SetupArgs% %Bootloader% %Bootapp% %Firmware% %Partitions% %Spiffs%
