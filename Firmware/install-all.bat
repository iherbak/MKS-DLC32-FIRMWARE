...
set SetupArgs=--before default_reset --after hard_reset write_flash -z --flash_mode keep --flash_freq keep --flash_size keep --erase-all
...
set Spiffs=0x670000 %BuildDir%\spiffs.bin
